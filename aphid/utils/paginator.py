...
class Pages:
    ...
    def __init__(self, ctx, *, entries, per_page=10, show_entry_count=True):
        ...
        if not self.permissions.send_messages:
            raise CannotPaginate('Bot does not have Send Messages permission.')
    ...
    async def show_page(self, page, *, first=False):
        ...
        if self.maximum_pages > 1:
            ...
            text = f'{len(self.entries)} entries'
            self.embed.set_footer(text=text)
    ...
    async def show_help(self):
        ...
        self.embed.title = 'Welcome to the interactive paginator!'
        self.embed.description = 'This interactively allows you to see pages of text by navigating with reactions.'
...
class HelpPaginator(Pages):
    ...
    def get_bot_page(self, page):
        ...
        self.title = f'__{cog} Commands__'
